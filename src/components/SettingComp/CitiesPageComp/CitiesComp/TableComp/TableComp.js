...
function createData(name, nameEn, CountryNumber, cityNumber) {
  return {
    name,
    nameEn,
    CountryNumber,
...
const rows = [
  createData("جدة", "Jeddah", "966", "012"),
  createData("الدمام", "Dammam", "972", "013"),
  createData("عمان", "oman", "962", "250441"),
];
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">
                        <h2 className="font-medium">{row.cityNumber}</h2>
                      </TableCell>
                      <TableCell align="right">
                        <h2 className="font-medium">{row.CountryNumber}</h2>
                      </TableCell>
