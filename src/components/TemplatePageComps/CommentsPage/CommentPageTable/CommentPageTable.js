...
function createData(name, circle, comment, city, active) {
  return {
    name,
    circle,
    comment,
...
const rows = [
  createData("عبد العزيز محمد", "عملاء", "منصة رائعة وشاملة", "الرياض", true),
  createData("خالد عبد الله حسين", "تجار", "جهود ممتازة", "الدمام", false),
  createData("عبد العزيز محمد", "عملاء", "منصة رائعة وشاملة", "الرياض", false),
  createData("خالد عبد الله حسين", "تجار", "جهود ممتازة", "الدمام", true),
  createData("عبد العزيز محمد", "عملاء", "منصة رائعة وشاملة", "الرياض", true),
  createData("خالد عبد الله حسين", "تجار", "جهود ممتازة", "الدمام", false),
  createData("عبد العزيز محمد", "عملاء", "منصة رائعة وشاملة", "الرياض", false),
  createData("خالد عبد الله حسين", "تجار", "جهود ممتازة", "الدمام", true),
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        ...
                        >
                          <h2>{row.active ? "مفعل" : "غير مفعل"}</h2>
                        </div>
                      </TableCell>
                      ...
                      <TableCell align="right">
                        <div>
                          <h2 className="font-medium">{row.circle}</h2>
                        </div>
                      </TableCell>
                      <TableCell align="right">
